...
Create a new lead in Qobrix CRM. Use the lead-capture skill for the full workflow.
...
3. Check for duplicate contacts in Qobrix
...
2. Check for duplicates in Qobrix using the API helper script
